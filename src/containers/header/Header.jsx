...
class Header extends Settings {
  ...
  getLanguagesButton() {
    const uaLanguageButton = window.document.querySelector(
      'button.lui-button[data-text="Ua"]'
    );
    const enLanguageButton = window.document.querySelector(
      'button.lui-button[data-text="En"]'
    );
    this.setState({
      uaLanguageButton,
      enLanguageButton
                    ...
                    <li className="navigation__nav-list-item">
                      ...
                      >
                        ...
                        <p className="navigation__nav-list-item-title">
                          <Trans i18nKey="menu.home">Головна</Trans>
                        </p>
                      </NavLink>
                    </li>
                    <Panel
                    ...
                    >
                      ...
                      >
                        <span className="navigation__dropdown-content-link-title top100Text">
                          <Trans i18nKey="top-100-menu-items.6m18">
                            6міс 2018
                          </Trans>
                        </span>
                      </a>
                      ...
                      >
                        <span className="navigation__dropdown-content-link-title top100Text">
                           <Trans i18nKey="top-100-menu-items.6m17">
                            6міс 2017
                          </Trans>
                        </span>
                      </a>
                      ...
                      >
                        <span className="navigation__dropdown-content-link-title top100Text">
                           <Trans i18nKey="top-100-menu-items.6m16">
                            6міс 2016
                          </Trans>
                        </span>
                      </a>
                    ...
                    <Panel
                      header={
                        ...
                        >
                          ...
                          <p className="navigation__nav-list-item-title">
                            <Trans i18nKey="menu.database">База даних</Trans>
                          </p>
                        </NavLink>
                      }
                    >
                ...
                <ul className="navigation__nav-list">
                  <li className="navigation__nav-list-item">
                    ...
                    >
                      <svg
                        ...
                        viewBox="0 0 16 16"
                      >
                        <path d="M7.98 2a.224.224 0 0 0-.154.065l-6.763 5.98c-.089.042-.092.13.042.13h.89c.134 0 .315-.088.404-.13l5.469-4.732a.237.237 0 0 1 .32 0l5.427 4.693c.089.042.27.13.403.13h.89c.09 0 .132-.047.043-.13L8.146 2.065A.258.258 0 0 0 7.98 2zm.055 2.08a.258.258 0 0 0-.167.065l-4.578 3.9c-.089.042-.18.213-.18.339V14h4.007v-2.496h1.78V14h4.008V8.384c0-.125-.091-.297-.18-.339l-2.269-1.95-2.351-2.002c-.005-.002-.01.001-.014 0-.022-.007-.033-.013-.056-.013z" />
                      </svg>
                      <p className="navigation__nav-list-item-title">
                        <Trans i18nKey="menu.home">Головна</Trans>
                      </p>
                  ...
                  <li className="navigation__nav-list-item finance dropdownDecor">
                    <svg
                      ...
                      viewBox="0 0 16 16"
                    >
                      <path d="M5.643 7.571v3.715H3.786V7.57h1.857zm2.786-3.714v7.429H6.57V3.857H8.43zm7.428 8.357v.929H1V2h.929v10.214h13.928zm-4.643-6.5v5.572H9.357V5.714h1.857zM14 2.93v8.357h-1.857V2.929H14z" />
                    </svg>
                    <p className="navigation__nav-list-item-title">
                      <Trans i18nKey="menu.finance-statistics">
                        Фінансова статистика
